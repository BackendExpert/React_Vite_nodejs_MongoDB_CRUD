  ...
  return (
    <div className="bg-blue-600 h-screen px-24 py-20">
      <div className="bg-white text-black px-12 py-8 rounded">
        ...
        <p className="font-semibold text-2xl py-4">Update User</p>
        <hr />
        ...
        <form>
          ...
          <button className="rounded bg-blue-700 duration-500 hover:bg-blue-800 text-white py-4 px-8 font-semibold text-md">Add Update</button>
        </form>
